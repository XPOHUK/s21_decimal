...
START_TEST(test_debug_create1) {
  s21_decimal decimal =
      s21_create_decimal_from_array(0xFFFFFFFF, 0x1, 0x0, 0x1C0000);
...
START_TEST(test_debug_create2) {
  s21_decimal decimal =
      s21_create_decimal_from_data(1, 28, 0xFFFFFFFF, 0x1, 0x0);
  char check[1024] = "-0.0000000000000000008589934591";
...
START_TEST(test_debug_create3) {
  s21_decimal decimal =
      s21_create_decimal_from_strings("11111111 11111111 11111111 11111111",
