...
/**
 * @brief 0,1,2 -- соответствующие части decimal. Четвёртый int записываем в
 * parts[6] и переставляем или дублируем знаковый бит из 31 в 0
 */
...
int big_decimal_div(big_decimal dividend, big_decimal divisor,
                    big_decimal* result);
int big_decimal_mul_big_int(big_decimal first, big_decimal second,
                            big_decimal* result);
