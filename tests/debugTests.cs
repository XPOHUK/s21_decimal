...
class DebugTests
{
    public static void ShowTestOk(decimal Argument) {
        ...
        Console.WriteLine( "    char check[1024] = \"{0}\";", Argument);
        Console.WriteLine("");
        Console.WriteLine("    test_debug(decimal, check);");
    }
    ...
    {   
        ...
        foreach (decimal number in tests_ok) {
            i++;
            Console.WriteLine("START_TEST(test_debug_ok{0}) {{", i);
            ShowTestOk(number);
            Console.WriteLine("}");
            Console.WriteLine("");
        }
        ...
        foreach (decimal number in tests_ok) {
            if (i % 400 == 0) {
                Console.WriteLine("Suite * debug{0}(void) {{", suit_num);
            ...
            i++;
            Console.WriteLine("    tcase_add_test(tc_core, test_debug_ok{0});", i);
            if (i % 400 == 0) {
                Console.WriteLine("");
