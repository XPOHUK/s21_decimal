 ...
 * заданное значение типа Decimal больше другого заданного значения типа
 * Decimal. Бит 31 содержит знак; 0 означает положительный, а 1 означает
 * отрицательный.
...
int s21_is_greater(s21_decimal value_1, s21_decimal value_2) {
  ...
  if (big_decimal_compare(big_decimal_1, big_decimal_2) ==
      BIG_DECIMAL_COMPARISON_FIRST_GREATER) {
