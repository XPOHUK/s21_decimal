 ...
 *
 * Касательно перевода числа - алгоритм перевода двоичного числа в десятичное
 * довольно очевиден и легко гуглится :) Разберем на примере числа 101001011:
 *
 * 101001011 = 1*2^8 + 0*2^7 + 1*2^6 + 0*2^5 + 0*2^4 + 1*2^3 + 0*2^2 + 1*2^1 +
 * 1*2^0 = = 256 + 0 + 64 + 0 + 0 + 8 + 0 + 2 + 1 = 331
 *
 * Т.е. младший бит - это нулевая степень двойки, 1й бит - первая степень, 2й
 * бит - вторая степень и т.д. И эта степень умножается на 1 или 0 (смотря какое
 * значение имеет бит двоичного числа)
 *
