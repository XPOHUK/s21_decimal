...
START_TEST(test_div402) {
    ...
    // -9364712231340627836019760.832
    s21_decimal decimal_check = {{0x9ACD5EC0, 0x4BCA35AA, 0x1E424EF3, 0x80030000}};
...
START_TEST(test_div406) {
    ...
    // -79149013500763574019524425908
    s21_decimal decimal_check = {{0xFBE878B4, 0x6170458F, 0xFFBE878B, 0x80000000}};
...
START_TEST(test_div418) {
    ...
    // -21669104637638919604.083853925
    s21_decimal decimal_check = {{0x63478A65, 0x327B2965, 0x46044364, 0x80090000}};
...
START_TEST(test_div420) {
    ...
    // -126429998059967356684.63712959
    s21_decimal decimal_check = {{0xFF91BABF, 0xD1DCAEAC, 0x28DA0B58, 0x80080000}};
...
START_TEST(test_div429) {
    ...
    s21_decimal decimal_check = {{0xDF606343, 0x7C4A04C1, 0x409F9CBC, 0x801C0000}};
...
START_TEST(test_div433) {
    ...
    s21_decimal decimal_check = {{0x1FFFFFFF, 0x7C4A04C2, 0x409F9CBC, 0x80000000}};
...
START_TEST(test_div435) {
    ...
    s21_decimal decimal_check = {{0x3B9AC9FF, 0xC4653600, 0x3B9AC9FF, 0x80090000}};
...
START_TEST(test_div437) {
    ...
    s21_decimal decimal_check = {{0x4E250261, 0x5E74D0BF, 0x204FCE5E, 0x801C0000}};
...
START_TEST(test_div441) {
    ...
    s21_decimal decimal_check = {{0xFFFFFFFF, 0xFFFFFFFF, 0x773593FF, 0x80090000}};
...
START_TEST(test_div445) {
    ...
    s21_decimal decimal_check = {{0x33333333, 0x33333333, 0x33333333, 0x80000000}};
...
START_TEST(test_div447) {
    ...
    s21_decimal decimal_check = {{0xFFFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF, 0x80000000}};
...
START_TEST(test_div453) {
    ...
    s21_decimal decimal_check = {{0xFFFFFFF6, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}};
...
START_TEST(test_div463) {
    ...
    s21_decimal decimal_check = {{0x10000000, 0x3E250261, 0x204FCE5E, 0x80000000}};
...
START_TEST(test_div465) {
    ...
    s21_decimal decimal_check = {{0xAAAAAAA9, 0xAAAAAAAA, 0x2AAAAAAA, 0x80010000}};
...
START_TEST(test_div473) {
    ...
    s21_decimal decimal_check = {{0xA3B5FB3E, 0x3BAA6805, 0x409F9CBC, 0x800D0000}};
...
START_TEST(test_div477) {
    ...
    s21_decimal decimal_check = {{0xFFFFFFFF, 0xFFFFFFFF, 0x773593FF, 0x80050000}};
...
START_TEST(test_div483) {
    ...
    s21_decimal decimal_check = {{0xB2D05DFF, 0xB2D05E00, 0xB2D05E00, 0x80000000}};
...
START_TEST(test_div508) {
    ...
    s21_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80010000}};
    // -3.3333333333333333333333333333
    s21_decimal decimal_check = {{0x35555555, 0xCF2607EE, 0x6BB4AFE4, 0x801C0000}};
...
START_TEST(test_div514) {
    ...
    s21_decimal decimal2 = {{0x80000000, 0x0, 0x80000000, 0x80000000}};
    // -0.6666666666666666666305265942
    s21_decimal decimal_check = {{0xF5202116, 0x296E0195, 0x158A8994, 0x801C0000}};
...
START_TEST(test_div518) {
    ...
    s21_decimal decimal2 = {{0x0, 0x0, 0x80000000, 0x801C0000}};
    // -6666666666666666666666666666.6
    s21_decimal decimal_check = {{0x6AAAAAAA, 0x9E4C0FDC, 0xD7695FC9, 0x80010000}};
...
START_TEST(test_div520) {
    ...
    s21_decimal decimal2 = {{0x1, 0x1, 0x0, 0x80000000}};
    // -6148914689804861440.3333333332
    s21_decimal decimal_check = {{0xC6AEA154, 0x8EA6B400, 0xC6AEA154, 0x800A0000}};
...
START_TEST(test_div524) {
    ...
    s21_decimal decimal2 = {{0x0, 0x1, 0x0, 0x80000000}};
    // -6148914691236517205.3333333333
    s21_decimal decimal_check = {{0x55555555, 0x55555555, 0xC6AEA155, 0x800A0000}};
...
START_TEST(test_div526) {
    ...
    s21_decimal decimal2 = {{0x80000000, 0x0, 0x0, 0x80000000}};
    // -12297829382473034410.666666667
    s21_decimal decimal_check = {{0xAAAAAAAB, 0xAAAAAAAA, 0x27BC86AA, 0x80090000}};
...
START_TEST(test_div528) {
    ...
    s21_decimal decimal2 = {{0xFFFFFFFF, 0x1, 0x0, 0x80000000}};
    // -3074457345976172544.0416666666
    s21_decimal decimal_check = {{0x18D5D42A, 0xDC565300, 0x635750AA, 0x800A0000}};
...
START_TEST(test_div534) {
    ...
    s21_decimal decimal2 = {{0x1FFFFC18, 0x7C4A04C2, 0x409F9CBC, 0x801C0000}};
    // -13204693752377389598923992383
    s21_decimal decimal_check = {{0xAAAAAD3F, 0xAAAAAAAA, 0x2AAAAAAA, 0x80000000}};
...
START_TEST(test_div536) {
    ...
    s21_decimal decimal2 = {{0x1FFFFFFF, 0x7C4A04C2, 0x409F9CBC, 0x801C0000}};
    // -13204693752377389598923991723
    s21_decimal decimal_check = {{0xAAAAAAAB, 0xAAAAAAAA, 0x2AAAAAAA, 0x80000000}};
...
START_TEST(test_div548) {
    ...
    s21_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x801C0000}};
    // -3333333333333333333333333333.3
    s21_decimal decimal_check = {{0x35555555, 0xCF2607EE, 0x6BB4AFE4, 0x80010000}};
...
START_TEST(test_div550) {
    ...
    s21_decimal decimal2 = {{0x60000005, 0x74DE0E46, 0xC1DED635, 0x801B0000}};
    // -440156458412579653297466390.71
    s21_decimal decimal_check = {{0xE38E38DF, 0x38E38E38, 0x8E38E38E, 0x80020000}};
...
START_TEST(test_div558) {
    ...
    s21_decimal decimal2 = {{0x80000000, 0x80000000, 0x80000000, 0x800F0000}};
    // -666666666511446.23756408691406
    s21_decimal decimal_check = {{0xCC5E9ACE, 0xC6E2B012, 0xD7695FC8, 0x800E0000}};
...
START_TEST(test_div560) {
    ...
    s21_decimal decimal2 = {{0x0, 0x1, 0x0, 0x80080000}};
    // -614891469123651720533333333.33
    s21_decimal decimal_check = {{0x55555555, 0x55555555, 0xC6AEA155, 0x80020000}};
...
START_TEST(test_div562) {
    ...
    s21_decimal decimal2 = {{0x80000000, 0x0, 0x0, 0x80040000}};
    // -122978293824730344106666.66667
    s21_decimal decimal_check = {{0xAAAAAAAB, 0xAAAAAAAA, 0x27BC86AA, 0x80050000}};
...
START_TEST(test_div566) {
    ...
    s21_decimal decimal2 = {{0x270F, 0x0, 0x0, 0x80040000}};
    // -26412028707625541752023185764
    s21_decimal decimal_check = {{0x10307964, 0x3A54C753, 0x555784A1, 0x80000000}};
...
START_TEST(test_div568) {
    ...
    s21_decimal decimal2 = {{0x55555555, 0x0, 0x0, 0x80090000}};
    // -18446744078004518913000000000
    s21_decimal decimal_check = {{0x3B9ACA00, 0x3B9ACA00, 0x3B9ACA00, 0x80000000}};
...
START_TEST(test_div570) {
    ...
    s21_decimal decimal2 = {{0x811800, 0x0, 0x0, 0x80030000}};
    // -3121570743780209278673253.6109
    s21_decimal decimal_check = {{0xAEAC912D, 0xFCA20838, 0x64DD072A, 0x80040000}};
...
START_TEST(test_div572) {
    ...
    s21_decimal decimal2 = {{0x1F40, 0x0, 0x0, 0x80030000}};
    // -3301173438094347399730997930.6
    s21_decimal decimal_check = {{0xAAAAAAAA, 0xAAAAAAAA, 0x6AAAAAAA, 0x80010000}};
...
START_TEST(test_div574) {
    ...
    s21_decimal decimal2 = {{0x3E9, 0x0, 0x0, 0x80030000}};
    // -26383004500254524673174808636
    s21_decimal decimal_check = {{0x53F8283C, 0xCB256C85, 0x553F8283, 0x80000000}};
...
START_TEST(test_div586) {
    ...
    s21_decimal decimal2 = {{0x3C2CB7A1, 0x3E0B91AF, 0x7623FB44, 0x80130000}};
    // -7223034879212973201.3612846418
    s21_decimal decimal_check = {{0xA043CD52, 0xFD9A89FC, 0xE9638B4D, 0x800A0000}};
...
START_TEST(test_div588) {
    ...
    s21_decimal decimal2 = {{0xD8705E63, 0x5DC32547, 0xCA7BCC9C, 0x80140000}};
    // -42143332686655785561.545709863
    s21_decimal decimal_check = {{0xA93B1927, 0xBB8A4640, 0x882C25D2, 0x80090000}};
...
START_TEST(test_div674) {
    ...
    s21_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80000000}};
    // -0.5000000000000000000271050543
    s21_decimal decimal_check = {{0x9827E72F, 0x1F128130, 0x1027E72F, 0x801C0000}};
...
START_TEST(test_div676) {
    ...
    s21_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x80010000}};
    // -5.0000000000000000002710505432
    s21_decimal decimal_check = {{0xF18F07D8, 0x36B90BE5, 0xA18F07D7, 0x801C0000}};
...
START_TEST(test_div684) {
    ...
    s21_decimal decimal2 = {{0x0, 0x0, 0x80000000, 0x80000000}};
    // -1.0000000000000000000542101086
    s21_decimal decimal_check = {{0x304FCE5E, 0x3E250261, 0x204FCE5E, 0x801C0000}};
...
START_TEST(test_div686) {
    ...
    s21_decimal decimal2 = {{0x0, 0x0, 0x80000000, 0x801C0000}};
    // -10000000000000000000542101086
    s21_decimal decimal_check = {{0x304FCE5E, 0x3E250261, 0x204FCE5E, 0x80000000}};
...
START_TEST(test_div690) {
    ...
    s21_decimal decimal2 = {{0xFFFFFFFF, 0x0, 0xFFFFFFFF, 0x80000000}};
    // -0.5000000001164153218540398688
    s21_decimal decimal_check = {{0xB73A6860, 0x2F3A685F, 0x1027E72F, 0x801C0000}};
...
START_TEST(test_div698) {
    ...
    s21_decimal decimal2 = {{0x5, 0x0, 0x0, 0x80000000}};
    // -7922816251426433759783891763
    s21_decimal decimal_check = {{0xB3333333, 0x99999999, 0x19999999, 0x80000000}};
...
START_TEST(test_div716) {
    ...
    s21_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x801C0000}};
    // -5000000000000000000271050543.2
    s21_decimal decimal_check = {{0xF18F07D8, 0x36B90BE5, 0xA18F07D7, 0x80010000}};
...
START_TEST(test_div718) {
    ...
    s21_decimal decimal2 = {{0x60000005, 0x74DE0E46, 0xC1DED635, 0x801B0000}};
    // -660234687618869479981990980.21
    s21_decimal decimal_check = {{0x2AAAAAA5, 0x55555556, 0xD5555555, 0x80020000}};
...
START_TEST(test_div726) {
    ...
    s21_decimal decimal2 = {{0x80000000, 0x80000000, 0x80000000, 0x800F0000}};
    // -999999999767169.3564003404797
    s21_decimal decimal_check = {{0xF22ACBFD, 0x1DD53402, 0x204FCE5E, 0x800D0000}};
...
START_TEST(test_div734) {
    ...
    s21_decimal decimal2 = {{0x270F, 0x0, 0x0, 0x80040000}};
    // -39618043061438312630182477064
    s21_decimal decimal_check = {{0x184BFD08, 0xD77F2AFD, 0x800346F1, 0x80000000}};
...
START_TEST(test_div736) {
    ...
    s21_decimal decimal2 = {{0x55555555, 0x0, 0x0, 0x80090000}};
    // -27670116117006778371000000001
    s21_decimal decimal_check = {{0xB2D05E01, 0x59682F00, 0x59682F00, 0x80000000}};
...
START_TEST(test_div742) {
    ...
    s21_decimal decimal2 = {{0x3E9, 0x0, 0x0, 0x80030000}};
    // -39574506750381787011907551265
    s21_decimal decimal_check = {{0x7DD38021, 0xB0B822C8, 0x7FDF43C5, 0x80000000}};
...
START_TEST(test_div754) {
    ...
    s21_decimal decimal2 = {{0x3C2CB7A1, 0x3E0B91AF, 0x7623FB44, 0x80130000}};
    // -10834552318819459802.629269221
    s21_decimal decimal_check = {{0xD4A5E6E5, 0x193D94B2, 0x230221B2, 0x80090000}};
...
START_TEST(test_div756) {
    ...
    s21_decimal decimal2 = {{0xD8705E63, 0x5DC32547, 0xCA7BCC9C, 0x80140000}};
    // -63214999029983678345.745456759
    s21_decimal decimal_check = {{0xCA1ADE77, 0x194F6961, 0xCC4238BC, 0x80090000}};
